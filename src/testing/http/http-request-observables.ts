...
export type ResponseObjTypes = ArrayBuffer | Blob | SimpleResponseObjTypes | SimpleResponseObjTypes[];
...
export function executeObservableWithHttpRequest<T, TRequest>(
  ...
  const httpTestingController: HttpTestingController = TestBed.inject<HttpTestingController>(HttpTestingController as Type<HttpTestingController>);
